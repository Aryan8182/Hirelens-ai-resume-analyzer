...
├── HireLens_Presentation.pptx  # 12-Slide Widescreen PowerPoint Presentation
...
- **Live Application**: [Click Me](https://aryan8182-hirelens-ai-resume-analyzer-app-p2fpgo.streamlit.app/)
- **License**: MIT License
